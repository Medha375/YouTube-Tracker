...
content.js sits on youtube.com and notices when you open a new video or Short
background.js grabs that video's metadata from the YouTube Data API, sorts it into a genre, and saves it locally
dashboard.jsx (React + Recharts) reads that saved data and turns it into the report you actually see
...
Head to Google Cloud Console, make a project if you don't have one
Enable YouTube Data API v3
Create an API key under Credentials, copy it
Drop it into YT_API_KEY in both background.js and src/dashboard.jsx
